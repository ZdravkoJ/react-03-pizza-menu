    ...
    <main>
      <div className="menu">
        ...
        {numPizzas > 0 ? (
          <React.Fragment>
            <p>
              Authentic italian cuisine. 6 cretive dishes to choose from. All
              from out stone oven, all orgnic, all delicious!
            </p>
...
function Order({ closeHour, openHour }) {
  return (
    <div className="order">
      <p>
        We are Open from {openHour}:00 until {closeHour}:00 every working day!
      </p>
